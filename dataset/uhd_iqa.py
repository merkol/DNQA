...
class UHD_IQA(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.subset == "training":
            label = self.metadata.loc[self.metadata["image_name"] == self.imgs[index].name, "quality_mos"].values[0]
            return img, label
        else:
            return img
...
if __name__ == "__main__":
    ...
    dataset = UHD_IQA(root="/home/vgl/Research/DNQA/challenge", transform=transforms, subset="training")
